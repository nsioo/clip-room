  ...
  <div class="slider-container">
    <div class="slider-holder" @wheel="wheelPbr">
      <v-slider
        ...
        max="2"
        step="0.001"
        v-model="rawPlaybackRate"
      ></v-slider>
      <div class="slider-label">
        <p>播放速率: {{ activeFragment.playbackRate.toFixed(2) }}x</p>
      </div>
    </div>
    <v-tooltip bottom>
...
export default {
  ...
  watch: {
    ...
    rawPlaybackRate() {
      ...
      if (this.rawPlaybackRate > 1) playbackRate = 1 + (this.rawPlaybackRate - 1) * 7;
      if (this.commit) this.setPlaybackRate({ playbackRate });
