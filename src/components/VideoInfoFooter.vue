<template>
    <div class="video-info">
        <div class="info-text">
            <span @click="openFolder(video.filePath)" v-ripple class="clickable not-uppercase">正在编辑: {{
                    video.fileName
                }}</span>
            ...
            <span>比特率: <span class="not-uppercase">{{ readableBitrate(video.bitrate) }}</span></span>
        </div>
